...
CREATE OR REPLACE FUNCTION html2pdf(data TEXT[]) RETURNS TEXT AS 'MODULE_PATHNAME', 'html2pdf_array' LANGUAGE 'c';
CREATE OR REPLACE FUNCTION html2ps(data TEXT[]) RETURNS TEXT AS 'MODULE_PATHNAME', 'html2ps_array' LANGUAGE 'c';
